module Eino-RAG-example

go 1.24.2

require (
	github.com/cloudwego/eino v0.3.28
	github.com/cloudwego/eino-ext/components/document/loader/file v0.0.0-20250507115047-b20720df8528
	github.com/cloudwego/eino-ext/components/document/transformer/splitter/markdown v0.0.0-20250507115047-b20720df8528
	github.com/cloudwego/eino-ext/components/embedding/ark v0.0.0-20250507115047-b20720df8528
	github.com/cloudwego/eino-ext/components/indexer/redis v0.0.0-20250507115047-b20720df8528
